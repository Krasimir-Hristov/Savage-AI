...
- [x] **Step 3.3: Chat API route handler**
...
- [x] **Atomic re-embed swap** (`src/features/rag/services/embed-entry.ts`)
...
- [x] **Zod validation for multipart FormData upload** (`src/app/api/knowledge/route.ts` POST)
...
- [x] **DAL typed errors: 404 vs 500 distinction** (`src/features/rag/dal.ts`)
